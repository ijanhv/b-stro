...
export const AboutUs = () => {
  return (
    <div className="relative h-[1000px]  lg:h-screen ">
      <Image
      ...
      <div className="absolute top-0 left-0  w-full h-full bg-black bg-opacity-50 flex items-center justify-center">
        <div className="box h-full grid grid-cols-1 lg:grid-cols-3 gap-3 items-center">
          <div className="flex flex-col items-center  lg:items-end gap-7">
            <h3 className="text-4xl lg:text-6xl font-semibold font-cormorant text-white">
              About Us
            </h3>
          ...
          <div className="relative h-[300px] lg:h-full w-full">
            <Image
              ...
              alt="About Us"
              fill
              className="w-full h-full object-contain lg:py-36 "
            />
